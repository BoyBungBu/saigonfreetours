...
function SFT_js_alter(&$javascript) {
...
function SFT_preprocess_block(&$vars) {
...
function SFT_region_has_block($region) {
...
function SFT_get_span($block_count, $block_id, $count_sidebars) {
 ...
 */
function SFT_status_messages($variables) {
...
function SFT_form_alter(&$form, &$form_state, $form_id) {
...
function SFT_menu_local_tasks(&$vars) {
  $output = '';
...
function SFT_menu_local_task($vars) {
...
function SFT_menu_link(array $vars) {
...
function SFT_is_in_nav_menu($element) {
...
function SFT_block_id_to_function_name ($id) {
...
function SFT_breadcrumb(&$variables) {
  $output = '';
